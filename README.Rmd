...
This project has been forked from https://github.com/cloudyr/aws.dynamodb/ which is not maintained anymore.
Few improvements have been done too such as automatic post processing of results and to be able to use a local version of dynamodb.
...
This package is not yet on CRAN. To install the latest development version you can install github:
